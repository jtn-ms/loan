...
import Deep2EssenceLoanDeep2EssenceLoanLoan from './deep2essence/loan/deep2essence.loan.loan'
...
export default { 
  ...
  Deep2EssenceLoanDeep2EssenceLoanLoan: load(Deep2EssenceLoanDeep2EssenceLoanLoan, 'deep2essence.loan.loan'),
