...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/deep2essence/loan/loan/loan
   */
  queryLoanAll = (
    query?: {
    ...
    this.request<LoanQueryAllLoanResponse, RpcStatus>({
      path: `/deep2essence/loan/loan/loan`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/deep2essence/loan/loan/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<LoanQueryParamsResponse, RpcStatus>({
      path: `/deep2essence/loan/loan/params`,
      method: "GET",
      format: "json",
      ...params,
    });
